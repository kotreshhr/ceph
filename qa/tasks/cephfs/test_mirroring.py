...
class TestMirroring(CephFSTestCase):
    ...
    def test_cephfs_mirror_multithread_snapshot_only_dirs_sync(self):
        ...
        ... When snapshot containing only directories and no files, are queued for syncing, the
        the sync hangs in following scenario.
            1. Configure say /d0 and /d1 for mirroring.
            2. Create around 10k files in /d0
            3. Create a single dir say /d1/dir0 or nothing
            4. snapshot /d0 and wait for status to change for 'syncing'
            5. Now, snapshot /d1.
        ...
        #  1. Disable distribute_datasync_threads options -
        #       This guarantees that the /d1 is not picked up for syncing before /d0 snapshot
        #       is synced i.e, all datasync threads are busy syncing /d0.
        #  2. Create more files (10k) for /d0 -
